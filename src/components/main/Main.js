...
import Checklist from "./display/Checklist";
import History from "./display/History";
import Streaks from "./display/Streaks";

export default function Main({ setSetupFormActive, setupFormActive, habitList, createHabitList, currentDay, completeHabit, updateHabitQuantity, toggleStreaks, streaksActive, setStreaksActive, records, today }) {
  ...
  return (
    <div>
        ...
        {
            setupFormActive && <HabitSetup habitList={habitList} createHabitList={createHabitList} setSetupFormActive={setSetupFormActive} />
        }

        <Checklist currentDay={currentDay} completeHabit={completeHabit} updateHabitQuantity={updateHabitQuantity} toggleStreaks={toggleStreaks} streaksActive={streaksActive} />

        {
          streaksActive && <Streaks habits={habitList} setStreaksActive={setStreaksActive} />
        }
